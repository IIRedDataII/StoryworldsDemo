...
public static class Texts
{
    ...
    public static readonly string[] RebelDialogueTranslated =
    {
        ...
        */
        ...
        "Du wichtig in Religion. Du -placeholder-. -placeholder- Teufel. -placeholder- Macht. -placeholder- Angst.",
        "Das Prophezeiung in Religion. Das sagen Zeichen auf Steintafel rechts. -placeholder-en kommen. -placeholder-en uns vernichten. ",
        ...
        "Du helfen. Du Volk zeigen -placeholder-en nicht böse. Du Volk zeigen Religion falsch. Du Pandora helfen System abschaffen.",
        "Ich... ",
